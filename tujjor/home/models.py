...
class  Setting(models.Model):
    ...
    email=models.CharField(blank=True,max_length=255) #email emailfieldda bolishi ham mimkun
...
class FAQ(models.Model):
    ...
    ordernamber=models.IntegerField()
...
class LicenseImages(models.Model):
    license=models.ForeignKey(License, on_delete=models.CASCADE)#shu yerda xatolik bor bolishi mumkin
    title=models.CharField(max_length=50,blank=True)
    image=models.ImageField(upload_to='images',blank=True)
    def __str__(self):
        return self.title